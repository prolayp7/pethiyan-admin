                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">GST Registration</h4>
                            @if($store->gst_registered)
                                <span class="badge bg-success-lt">GST Registered</span>
                            @else
                                <span class="badge bg-secondary-lt">Not Registered</span>
                            @endif
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table mb-0" style="border:none;">
                                    <tbody>
                                    <tr>
                                        <td class="fw-bold border-0" style="width:180px;">GSTIN</td>
                                        <td class="border-0">
                                            @if($store->gstin)
                                                <code class="fs-5">{{ $store->gstin }}</code>
                                            @else
                                    ...
                                    <tr>
                                        <td class="fw-bold border-0">GST State</td>
                                        <td class="border-0">
                                            {{ $store->state_name ?? '—' }}
                                            @if($store->state_code)
                                                <span class="badge bg-info-lt ms-1">{{ $store->state_code }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    </tbody>
