...
class PaymentSettingType implements SettingInterface
{
    ...
    protected static function getValidationRules(): array
    {
        return [
            ...
            'easepayPaymentMode'   => ['required_if:easepayPayment,1', new Enum(PaymentModeEnum::class)],
            'easepayMerchantKey'   => 'required_if:easepayPayment,1',
            'easepayMerchantSalt'  => 'required_if:easepayPayment,1',
