                ...
                <div class="wizard-step d-none" data-step="2">
                    <div class="container">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="hsn-code-main" name="hsn_code"
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="is_top_product">
                                        <option value="">Select Option</option>
                                        <option value="1" {{ !empty($product->is_top_product) ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option value="0" {{ empty($product->is_top_product) ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="gst_rate">
                                                ...
                                                @foreach(['0' => '0% — Nil / Exempt', '5' => '5% — Basic Necessities', '12' => '12% — Paper / Paperboard', '18' => '18% — Plastic / Electronics', '28' => '28% — Luxury / Demerit'] as $pct => $label)
                                                    <option value="{{ $pct }}"
                                                        {{ (!empty($product) && (string)$product->gst_rate === $pct) ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <small class="form-hint">Overrides the tax group rate for this specific product.</small>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">HSN Code</label>
                                            <input type="text" class="form-control" id="hsn-code-gst"
                                                   value="{{ $product->hsn_code ?? '' }}"
                                                   placeholder="e.g. 3923 (plastic), 4819 (paper)"/>
                                            <small class="form-hint">Mandatory on GST invoices. Auto-populated from product info step.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
