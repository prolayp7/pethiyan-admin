...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Setup / Maintenance Token
    |--------------------------------------------------------------------------
    | A secret token required to access the /migrate, /storage-link, and
    | /optimize-clean utility routes. Set SETUP_TOKEN in your .env file.
    | These routes also only respond in the local environment.
    |--------------------------------------------------------------------------
    */
