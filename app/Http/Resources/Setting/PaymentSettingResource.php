    ...
    public function toArray(Request $request): array
    {
        $data = [
            ...
            'value' => [
                ...
                'wallet' => $this->value['walletPayment'] ?? false,
                ...
                'easepayPayment'     => $this->value['easepayPayment']     ?? false,
                'easepayPaymentMode' => $this->value['easepayPaymentMode'] ?? '',
                'easepayMerchantKey' => $this->value['easepayMerchantKey'] ?? '',
            ]
        ];
        ...
        if ($this->getPanel() === 'admin') {
            $data['value'] = array_merge($data['value'], [
                ...
                'easepayMerchantSalt'  => $this->value['easepayMerchantSalt']  ?? '',
                'easepayWebhookSecret' => $this->value['easepayWebhookSecret'] ?? '',
            ]);
        }
