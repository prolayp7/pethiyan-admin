...
class PaymentSettingType implements SettingInterface
{
    ...
    public bool $walletPayment = false;
    ...
    public bool   $easepayPayment       = false;
    public string $easepayPaymentMode   = "";
    public string $easepayMerchantKey   = "";
    public string $easepayMerchantSalt  = "";
    public string $easepayWebhookSecret = "";
    ...
    protected static function getValidationRules(): array
    {
        return [
            ...
            'walletPayment' => 'nullable|boolean',
            ...
            'easepayPayment'       => 'nullable|boolean',
            'easepayPaymentMode'   => ['required_if:easepayPayment,true', new Enum(PaymentModeEnum::class)],
            'easepayMerchantKey'   => 'required_if:easepayPayment,true',
            'easepayMerchantSalt'  => 'required_if:easepayPayment,true',
            'easepayWebhookSecret' => 'nullable|string',
        ];
    }
    ...
    protected static function getValidationMessages(): array
    {
        return [
            ...
            'easepayPaymentMode.required_if'  => 'Easepay payment mode is required when Easepay is enabled.',
            'easepayMerchantKey.required_if'  => 'Easepay merchant key is required when Easepay is enabled.',
            'easepayMerchantSalt.required_if' => 'Easepay merchant salt is required when Easepay is enabled.',
        ];
    }
}
