...
// Error Messages
    ...
    'admin_note_placeholder' => 'Add an internal note for this order',
    'payment_activity' => 'Payment Activity',
    'latest_gateway_message' => 'Latest Gateway Message',
    'gateway_event' => 'Gateway Event',
    'gateway_failure_details' => 'Gateway Failure Details',
    ...
    'razorpay_webhook_setup_help' => 'Use this endpoint and secret when creating the Razorpay webhook. Subscribe only to the events currently handled by the backend.',
    'razorpay_supported_webhook_events' => 'Supported Razorpay Webhook Events',
    'no_payment_message_available' => 'No payment message available yet.',
    'online_payment_waiting_for_gateway_update' => 'This online payment will update here automatically after the payment gateway callback/webhook is received.',
    'cod_payment_waiting_for_admin_update' => 'This COD order has not been manually reconciled yet. Use the order management form to update payment status when cash is confirmed.',
    'order_management' => 'Order Management',
    'save_changes' => 'Save Changes',
    'cod_payment_status_updated_by_admin' => 'COD payment status updated by admin',
    ...
    'webhook_secret_generated_for_domain' => 'Generated for domain',
    'webhook_secret_read_only_help' => 'This token is auto-generated once per domain and cannot be edited manually.',
    ...
    'cost_required_numeric'        => 'Cost is required and must be a number.',
    'sku_required'                 => 'SKU is required.',
    'stock_required_non_negative'  => 'Stock is required and must be 0 or greater.',
    'otp_sent_successfully'        => 'OTP sent successfully.',
    'otp_resent_successfully'      => 'OTP resent successfully.',
    'sms_send_failed'              => 'Failed to send OTP. Please try again.',
    'welcome_wallet_bonus'         => 'Welcome bonus',
    'otp_expired_or_not_found'     => 'OTP not found or has expired. Please request a new OTP.',
    'otp_expired'                  => 'OTP has expired. Please request a new OTP.',
    'otp_max_attempts_exceeded'    => 'Maximum OTP attempts exceeded. Please request a new OTP.',
    'otp_invalid'                  => 'The OTP you entered is incorrect.',
    'mobile_verified_successfully' => 'Mobile number verified successfully.',
    'mobile_not_verified'          => 'Your mobile number is not verified. Please verify your mobile to continue.',
