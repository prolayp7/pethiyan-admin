        ...
        <div class="row row-deck row-cards">
            ...
            <div class="col-sm-12 col-lg-4">
                <div class="row row-cards">
                    ...
                    {{-- Delivery Boys card hidden (not used in this system) --}}
                            ...
                            <span class="bg-yellow text-white avatar">
                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  ...
                                  class="icon icon-tabler icons-tabler-outline icon-tabler-bike"><path stroke="none"
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{$adminInsights['total_active_delivery_boys']}} Active Delivery Boys</div>
                                        <div class="text-secondary">{{$adminInsights['total_delivery_boys']}} Total Delivery</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-red text-white avatar">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                 stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-alert-triangle">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $adminInsights['low_stock_count'] }} Low Stock</div>
                                        <div class="text-secondary">{{ $adminInsights['out_of_stock_count'] }} Out of Stock</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="row row-cards">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card dashboard-metric-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">{{ __('labels.repeated_customer') }}</div>
                                    <div class="ms-auto lh-1">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-secondary repeated-customers-period" href="#"
                                               data-bs-toggle="dropdown"
                                               aria-haspopup="true" aria-expanded="false" data-period="30"
                                            >{{ __('labels.last_30_days') }}</a
                                            >
                                ...
                                <div class="d-flex align-items-baseline">
                                    <div class="h1 mb-3 me-2"
                                         id="repeated-customers-count">{{ $repeatedCustomersData['count'] }}</div>
                                    <div class="me-auto">
                                <span
                                    class="text-{{ $repeatedCustomersData['is_increase'] ? 'green' : 'red' }} d-inline-flex align-items-center lh-1"
                                    id="repeated-customers-trend">
                                  {{ abs($repeatedCustomersData['percentage_change']) }}%
                                  <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                                      height="24"
                                      ...
                                      class="icon ms-1 icon-2"
                                  >
                                    @if($repeatedCustomersData['is_increase'])
                                          <path d="M3 17l6 -6l4 4l8 -8"/>
                                          <path d="M14 7l7 0l0 7"/>
                                      @else
                                          <path d="M3 7l6 6l4 -4l8 8"/>
                            ...
                            <div id="chart-repeated-customers" class="chart-sm"></div>
                        </div>
                    </div>
                </div>
            </div>
...
@push('styles')
    ...
    <style>
        ...
        .dashboard-metric-card .chart-sm {
            height: 72px;
            min-height: 72px;
        }
    </style>
...
@push('script')
    ...
    <script>
        ...
        var dashboardData = {
            ...
            repeatedCustomersData: @json($repeatedCustomersData),
