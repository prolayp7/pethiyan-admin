...
@php
    ...
    $orderStatusLabel = \App\Enums\Order\OrderStatusEnum::tryFrom((string)$order->status)?->label()
            ...
            <table role="presentation" class="container" width="680" cellpadding="0" cellspacing="0" style="border-radius:12px; overflow:hidden;">
                <tr>
                    <td class="header mobile-pad" align="center" style="padding:24px 28px;">
                        ...
                        <div class="title" style="padding-top:10px;">Payment Confirmed</div>
                        <div class="sub" style="padding-top:6px;">Your order has been accepted and is being prepared.</div>
                    </td>
                </tr>
                <tr>
                    <td class="mobile-pad" style="padding:24px 28px;">
                        <div class="h2">Thank you, {{ $customerName }}</div>
                        <div class="p" style="padding-top:10px;">We've received your payment and your order has been accepted. You'll receive separate updates for shipment and delivery milestones.</div>
                        ...
                        <table role="presentation" width="100%" class="meta" cellpadding="0" cellspacing="0" style="margin-top:16px; border-radius:8px;">
                            <tr>
                                <td class="p" style="padding:12px 14px;">
                                    ...
                                    <strong>Order Status:</strong> <span class="badge">{{ $orderStatusLabel }}</span><br>
