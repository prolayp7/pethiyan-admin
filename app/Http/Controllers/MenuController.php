...
<div class="d-flex gap-1 justify-content-center">
  ...
  <button class="btn btn-sm btn-outline-secondary menu-edit-btn" data-id="{$menu->id}" data-url="{$editUrl}" title="Edit">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <button class="btn btn-sm btn-outline-danger menu-delete-btn" data-id="{$menu->id}" data-url="{$deleteUrl}" title="Delete">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
